$(document).on('turbolinks:load', function () {
  if (typeof tinyMCE != 'undefined') {
    tinyMCE.init({
      ...
      toolbar: [
        "     bold italic forecolor backcolor fontsizeselect alignleft aligncenter alignright alignjustify restoredraft media preview save table"
      ],
      plugins: "link,autoresize,media,table,insertdatetime,charmap,print,preview,anchor,searchreplace,visualblocks,fullscreen,textcolor,media,autosave save"
    });
  } else {
